...
# *demos-lang-ts* project by Mark Veltzer

description: Demos for the typescript programming language

project website: https://veltzer.github.io/demos-lang-ts
...
![License](https://img.shields.io/github/license/veltzer/demos-lang-ts)

## build

![build](https://github.com/veltzer/demos-lang-ts/workflows/build/badge.svg)
